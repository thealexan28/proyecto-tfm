...
TRANSLATIONS = {
    ...
    "Sin clasificar": "Unclassified", "Airbnb mensualizado": "Monthly equivalent Airbnb price",
...
PHRASES = {
    ...
    "Brecha mensual por ciudad": "Monthly gap by city", "Airbnb mensualizado frente al alquiler habitual municipal": "Monthly equivalent Airbnb price vs municipal long-term rent",
    ...
    "Número de viviendas frente a Airbnb mensualizado por barrio": "Number of properties vs monthly equivalent Airbnb price by neighborhood",
    "Airbnb mensualizado por barrio (€)": "Monthly equivalent Airbnb price by neighborhood (€)",
